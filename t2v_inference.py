...
def load_t2v_model(model_filename, text_encoder_filename, is_720p):
    """
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Image-to-Video inference using WAN 2.1 t2v"
    )
    # Model + Tools
    parser.add_argument(
    ...
    parser.add_argument(
        "--transformer-file",
        type=str,
        default=f"{DATA_DIR}/wan2.1_text2video_14B_bf16.safetensors",
